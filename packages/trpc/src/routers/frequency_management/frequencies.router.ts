...
export const createFrequencySchema = z.object({
	...
	type: z.enum(frequencyTypeEnum.enumValues),
...
// Input schema for updating a frequency
export const updateFrequencySchema = z.object({
	...
	config: z.record(z.string(), z.any()).optional(), // Removed .nullable() as it's non-nullable in DB
	activeFrom: z
		.string()
		.datetime()
		.optional()
